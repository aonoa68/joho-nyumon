...
| 第12回 | 層別散布図 | [授業資料](week12.md) ／ [余談：シンプソンのパラドックス](week12-simpson.md) |
...
| 回 | 配布ファイル | 模範解答（完成例） |
|:---:|---|---|
| 第4回 | — | [自己紹介レポート(Word)](files/week04-model.docx) |
| 第5回 | — | [図表付きレポート(Word)](files/week05-model.docx) |
| 第6回 | — | [Excel完成例](files/week06-model.xlsx) ／ [最大行列版](files/week06-model-maxgrid.xlsx) |
| 第7回 | [ワークシート(Excel)](files/week07-worksheet.xlsx) | — |

!!! warning "模範解答の使い方"
    模範解答は「答え合わせ」や「やり方の確認」のためのものです。
    **そのまま提出するのは練習になりません。** まず自分でやってみて、つまずいたら参考にしてください。
